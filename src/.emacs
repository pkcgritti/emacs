...
(custom-set-faces
 ...
 '(default ((t (:background "#242424" :foreground "#f6f3e8"
			    ...
			    :foundry "PfEd" :family "Fira Code"))))
 '(company-preview ((t (:background "black" :foreground "white"))))
 '(company-preview-common ((t (:inherit company-preview :foreground "color-33"))))
 '(company-scrollbar-bg ((((type x)) (:background "gray12"))
			 (((type tty)) (:background "color-16"))))
 '(company-scrollbar-fg ((((type x)) (:background "royal blue"))
			 (((type tty)) (:background "blue"))))
 '(company-tooltip ((((type x)) (:background "gray9" :foreground "white"))
		    (((type tty)) (:background "brightblack" :foreground "white"))))
 '(company-tooltip-annotation ((t (:foreground "color-39"))))
 '(company-tooltip-common ((((type x)) (:foreground "royal blue"))
			   (((type tty)) (:foreground "color-33"))))
